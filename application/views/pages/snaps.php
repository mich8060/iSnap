...
<div id="snap">
	<div class="wide-container">
		<div class="grid_1 fluff">
			...
			<div class="hint"><? echo $data["item"][0]->date; ?></div>
		</div>
		...
		<div class="grid_4 fluff">
			<div class="previews">
				<div class="grid_2 flush">
					...
					<a href="<? echo $data["prev"][0]->url; ?>"><img src="<? echo base_url().$data["prev"][0]->image; ?>" alt="<? echo $data["prev"][0]->title; ?>" /><span>Prev</span></a>
					<? } ?>
				</div>
				<div class="grid_2 flush">
					<? if(isset($data["next"]) && $data["next"]) { ?>
					<a href="<? echo $data["next"][0]->url; ?>"><img src="<? echo base_url().$data["next"][0]->image; ?>" alt="<? echo $data["next"][0]->title; ?>" /><span>Next</span></a>
					<? } ?>
				</div>
			</div>
			<div class="clear"></div>
